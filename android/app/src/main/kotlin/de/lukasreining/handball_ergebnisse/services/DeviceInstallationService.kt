...
class DeviceInstallationService {
    ...
    companion object {
        const val DEVICE_INSTALLATION_CHANNEL = "de.lukasreining.handball_ergebnisse/notifications_deviceinstallation"
    ...
    fun getDeviceId(): String = Secure.getString(context.applicationContext.contentResolver, Secure.ANDROID_ID)
    ...
    fun getDevicePlatform(): String = "gcm"
